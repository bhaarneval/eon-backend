...
class SubscriptionViewSet(viewsets.ViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        queryset = queryset.select_related('payment').annotate(
            paid_amount=Value(0, IntegerField()))
    ...
    def create(self, request):
        ...
        if no_of_tickets < 0:
            ...
            tickets_data = instance.values('event').\
                annotate(total_tickets=Sum('no_of_tickets')).first()
